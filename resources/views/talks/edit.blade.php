                    ...
                    <div class="max-w-2xl mx-auto p-4">
                        <form class="space-y-6" method="POST" action="{{ route('talks.update', ['talk' => $talk]) }}">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ $talk->title }}"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="type" name="type"
                                        ...
                                        @foreach (App\Enums\TalkType::cases() as $talkType)
                                            <option value="{{ $talkType->value }}" @selected($talkType->value === old('type', $talk->type))>
                                                {{ $talkType->value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="length" name="length" value="{{ $talk->length }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            ...
                            <div>
                                ...
                                <textarea id="abstract" name="abstract" rows="4"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ $talk->abstract }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="organizer_notes" name="organizer_notes" rows="4"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ $talk->organizer_notes }}</textarea>
